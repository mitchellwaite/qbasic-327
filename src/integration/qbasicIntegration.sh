...
for dayFolder in $(ls ./res/userinput);do
   ...
   python tsfMerge.py ./beOut/mergedTsf_$dayFolder.txt `find ./out -name *.txt`

   # Run the backend
   python ../backend/main.py -a ./res/masterAccountsFile.txt -t ./beOut/mergedTsf_$dayFolder.txt -v ./beOut/validAccountsFile_$dayFolder.txt -o ./beOut/masterAccountsFile_$dayFolder.txt
